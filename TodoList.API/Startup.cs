        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(options =>
            {
                options.AddPolicy("ApiScope", policy =>
                {
                    ...
                    policy.RequireClaim("scope", "todoListAPI");
                });
            });
            ...
            services.AddDbContext<TodoListDbContext>(options => options.UseInMemoryDatabase(databaseName: "TodoListAppData"), ServiceLifetime.Singleton, ServiceLifetime.Singleton);
        }
